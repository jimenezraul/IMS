...
const productData = [
  // Foodservice Supplies
  {
    ...
    description:
      "Solo® treated paper cups offer superior rigidity for your cold beverage needs. Solo® treated paper cups also meet the ASTM standard for compostability and are made with at least 50% renewable resources.",
    price: 20.99,
    units: "case",
    user_id: 2,
    category_id: 1,
  ...
  },
  {
    ...
    description:
      "Capacity is 16-18 oz. Solo® treated paper cups offer superior rigidity for your cold beverage needs. BARE™ treated paper cups also meet the ASTM standard for compostability and are made with at least 50% renewable resources.",
    price: 25.99,
    units: "case",
    user_id: 3,
    category_id: 1,
  ...
  },
  {
    ...
    description:
      "8 oz. Maintain beverages at their optimal temperature longer with Dart insulated foam cups. Not only do foam cups keep beverages at their proper serving temperature on the inside, they keep hands comfortable on the outside. Hot or cold, insulated foam delivers drinks the way they were meant to be. Small drink cups are ideal for coffee, cappuccino, tea, hot chocolate, hot cider, juice, and soft drinks. For use with the Dart White 8 Series Lid.",
    price: 19.99,
    units: "case",
    user_id: 3,
    category_id: 1,
  ...
  },
  {
    ...
    description:
      "12 oz. Capacity. Solo® Ultra Clear™ cups will enhance your visibility with their crystal clarity and print capability. Multiple cups fit one lid size to simplify your operation and reduce storage costs.",
    price: 21.99,
    units: "case",
    user_id: 3,
    category_id: 1,
  ...
  },
  {
    ...
    description:
      "No-rinse, food-contact surface sanitizer and cleaner. Eliminates Norovirus, Salmonella, E. coli and Listeria in 30 seconds. No precautionary statements. No hand washing required after use. Proven effective across most hard and soft surfaces. Awarded the U.S. EPA Design for the Environment certification (DfE). Kosher Pareve.",
    price: 9.99,
    units: "case",
    user_id: 2,
    category_id: 2,
  ...
  },
  {
    ...
    description:
      "Touch-free hand sanitizer dispenser. Trouble-free performance. Fully ADA compliant, UL/CE registered. Sight window makes it easy to check refill level. Multiple colors and finishes available. Compatible with PURELL® TFX™ 1200 mL refills.",
    price: 10.99,
    units: "case",
    user_id: 3,
    category_id: 2,
